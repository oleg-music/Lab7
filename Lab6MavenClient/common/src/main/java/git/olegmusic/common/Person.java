...
public class Person implements Comparable<Person>, Serializable {
    ...
    /** 4) Геттер/сеттер для поля owner (логин пользователя-владельца) */
    ...
    /** Существует также метод для генерации idCounter, но после перехода на БД его можно не использовать */
