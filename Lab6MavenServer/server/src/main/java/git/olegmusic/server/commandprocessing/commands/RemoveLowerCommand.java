...
/**
 * Команда remove_lower {element} — удаляет из коллекции и БД все элементы,
 * которые меньше заданного и принадлежат текущему пользователю.
 */
public class RemoveLowerCommand implements Command {
    ...
    public String execute() {
        ...
        if (toRemove.isEmpty()) {
            return "Нет ваших элементов, меньших заданного.";
        }
    ...
    @Override
    public String descr() {
        return "remove_lower {element} : удалить из коллекции все элементы, меньшие заданного, принадлежащие текущему пользователю";
    }
}